...
public class LocationAssistant
    ...
    public void stop() {
        if (googleApiClient.isConnected()) {
            ...
            context.sendBroadcast(new Intent(Constants.EVENT.FUSED_LOCATION_API_DISCONNECTED));
    ...
    public void onConnectionSuspended(int i) {
        context.sendBroadcast(new Intent(Constants.EVENT.CONNECTION_SUSPENDED));
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        if (listener != null)
            listener.onError(ErrorType.RETRIEVAL, "Could not connect to Google API:\n" +
                    connectionResult.getErrorMessage());
        context.sendBroadcast(new Intent(Constants.EVENT.CONNECTION_FAILED));
    }
